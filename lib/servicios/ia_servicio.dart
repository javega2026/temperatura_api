...
class IaServicio {
  ...
  Future<String> obtenerAnalisisMedusas({required String ciudad}) async {
    final String ciudadConsulta = ciudad.trim();

    debugPrint('--------------------------------------------------');
    debugPrint('🚀 [LOG 3 - SERVICIO IA] Solicitando informe');
    debugPrint('   -> Ciudad recibida en el servicio: "$ciudadConsulta"');
    debugPrint('--------------------------------------------------');
    ...
    try {
      ...
      final prompt = "Proporciona una guía general y útil sobre la situación de las medusas en las costas de $ciudadConsulta, "
